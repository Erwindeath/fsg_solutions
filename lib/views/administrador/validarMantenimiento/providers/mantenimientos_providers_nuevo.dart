...
class MantenimientosNotifier extends StateNotifier<List<Mantenimientos>> {
  MantenimientosNotifier() : super([]);

  // Método para actualizar la lista de mantenimientos
  void actualizarMantenimientos(List<Mantenimientos> nuevosMantenimientos) {
    state = nuevosMantenimientos;
  }
...
final mantenimientosProvider = StateNotifierProvider<MantenimientosNotifier, List<Mantenimientos>>((ref) {
