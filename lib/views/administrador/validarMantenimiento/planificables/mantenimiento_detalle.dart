...
class DetalleMantenimientoWidget extends StatelessWidget {
  final Mantenimientos mantenimiento;
  VoidCallback onFechaSeleccionada;

  DetalleMantenimientoWidget({Key? key, required this.mantenimiento, required this.onFechaSeleccionada}) : super(key: key);
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              ElevatedButton(
                  onPressed: () async {
                    codUsuario = await storage.readSecureData("cod_usuario");
                    token = await storage.readSecureData("token");
                    mostrarDialogoConCalendario(context, now, onFechaSeleccionada, mantenimiento.codSolicitud, int.parse(codUsuario), token);
                  },
                  child: const Row(
  ...
  Future<void> mostrarDialogoConCalendario(
      BuildContext context, DateTime now, VoidCallback onConfirm, int codSolicitud, int codUsuario, String token) async {
