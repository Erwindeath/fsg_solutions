...
class InventarioReconteo extends ConsumerStatefulWidget {
  const InventarioReconteo({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _InventarioReconteoState();
}

class _InventarioReconteoState extends ConsumerState<InventarioReconteo> {
  bool activa = false;
  int cantidadCajas = 0;
